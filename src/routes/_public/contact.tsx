        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {contactInfo.map((info, index) => (
              ...
              >
                <div className="w-12 h-12 rounded-full bg-[#B8860B]/20 flex items-center justify-center mb-4">
                  <info.icon className="w-6 h-6 text-[#B8860B]" />
                </div>
          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              ...
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-lg text-white placeholder:text-white/30 focus:outline-none focus:border-[#B8860B] transition-colors"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              ...
              <div>
                ...
                <select
                  ...
                  onChange={handleChange}
                  required
                  className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-lg text-white focus:outline-none focus:border-[#B8860B] transition-colors"
                >
            ...
            <div className="mb-8">
              ...
              <textarea
                ...
                required
                rows={6}
                className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-lg text-white placeholder:text-white/30 focus:outline-none focus:border-[#B8860B] transition-colors resize-none"
            ...
            <button
              type="submit"
              className="w-full md:w-auto inline-flex items-center justify-center gap-2 bg-white text-black hover:bg-white/90 px-8 py-4 rounded-lg font-medium transition-colors"
            >
        ...
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-white/60 text-lg mb-8">
              Experience our luxury appliances firsthand at one of our showrooms
              worldwide.
            </p>
            <a
              href="/agents"
